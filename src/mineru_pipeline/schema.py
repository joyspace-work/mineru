...
VEHICLE_FIELDS: tuple[FieldSpec, ...] = (
    ...
    FieldSpec(
        db_column="single_model_total_stock",
        feishu_name="单车型总库存",
        pydantic_name="singleModelTotalStock",
        sql_type="INTEGER",
        excel_aliases=("单车型总库存", "车系总库存", "车型总库存", "总库存"),
        feishu_type="number",
        description="单车型总库存数量(整数)",
    ),
    FieldSpec(
        db_column="variant_stock",
        feishu_name="细分车型库存",
        pydantic_name="variantStock",
        sql_type="INTEGER",
        excel_aliases=("细分车型库存", "配置库存", "细分库存", "版本库存", "款型库存"),
        feishu_type="number",
        description="细分车型/配置版本库存数量(整数)",
    ),
    FieldSpec(
        db_column="color_stock",
        feishu_name="颜色库存",
        pydantic_name="colorStock",
        sql_type="INTEGER",
        excel_aliases=("颜色库存", "配色库存", "库存", "数量", "台数", "可订数量", "qty", "在库数量", "现货", "stockquantity"),
        feishu_type="number",
        description="拆分出的特定颜色库存数量(整数)",
    ),
    FieldSpec(
    ...
    FieldSpec(
        ...
        sql_type="INTEGER",
        excel_aliases=("出厂价", "exw", "exw价格", "出厂报价", "工厂价", "裸车价", "不含税价", "含税价", "国内价格", "单价", "价格", "costexwusd", "exw_price_usd", "exw_price_rmb", "exw_usd", "exw_price"),
        feishu_type="number",
    ...
    FieldSpec(
        ...
        sql_type="INTEGER",
        excel_aliases=("fob", "fob价格", "fob价", "离岸价", "costfobusd", "fob_price_usd", "fob_price_rmb", "fob_usd", "fob_price"),
        feishu_type="number",
    ...
    FieldSpec(
        ...
        sql_type="INTEGER",
        excel_aliases=("fca", "fca价格", "costfcausd", "fca_price_usd", "fca_price_rmb", "fca_usd", "fca_price"),
        feishu_type="number",
...
DEFAULT_KNOWLEDGE_BASE = {
    ...
    "header_aliases": {
        ...
        "priceExw": ["EXW", "EXW报价", "工厂交货价", "出厂价", "裸车价", "exw_price_usd", "exw_price_rmb", "exw_usd", "exw_price"],
        "priceFob": ["FOB", "FOB报价", "离岸价", "fob_price_usd", "fob_price_rmb", "fob_usd", "fob_price"],
        "priceFca": ["FCA", "FCA报价", "货运承运人价", "fca_price_usd", "fca_price_rmb", "fca_usd", "fca_price"],
